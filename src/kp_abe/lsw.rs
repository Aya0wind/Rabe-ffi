...
#[no_mangle]
pub unsafe extern "C" fn rabe_kp_lsw_decrypt(cipher: *const c_void, secret_key: *const c_void) -> CBoxedBuffer {
...
mod test {
    ...
    use crate::kp_abe::lsw::{rabe_kp_lsw_ciphertext_to_json, rabe_kp_lsw_decrypt, rabe_kp_lsw_encrypt, rabe_kp_lsw_free_ciphertext, rabe_kp_lsw_free_master_key, rabe_kp_lsw_free_public_key, rabe_kp_lsw_generate_secret_key, rabe_kp_lsw_init, rabe_kp_lsw_public_key_to_json, rabe_kp_lsw_secret_key_to_json};
    ...
    fn test() {
        unsafe {
            ...
            let secret_key = rabe_kp_lsw_generate_secret_key(public_key, master_key, policy.as_ptr());
